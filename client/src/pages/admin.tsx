...
import { LogOut, FileText, Clock, CheckCircle2, XCircle, Users, LayoutDashboard, Loader2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-semibold mb-6" data-testid="text-admin-title">
